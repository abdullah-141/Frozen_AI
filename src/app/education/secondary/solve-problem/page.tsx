...
export default function SecondarySolveProblemPage() {
    ...
    <div className="space-y-8">
      <div className="text-center">
        <h1 className="text-3xl font-bold text-foreground flex items-center justify-center">
          ...
          মাধ্যমিক স্তরের প্রশ্নোত্তর পর্ব
        </h1>
        <p className="text-lg text-muted-foreground mt-2">
          আপনার গণিত, বিজ্ঞান বা অন্যান্য বিষয়ের সমস্যার ছবি আপলোড করুন এবং বাংলায় ধাপে ধাপে সমাধান পান।
        </p>
      </div>
