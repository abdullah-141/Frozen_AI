...
Language Code: {{language}}`,
  config: {
    // Explicitly setting the API key is NOT required, but showing how it can be done.
    // Make sure to follow proper secret management.
    // The below key is a placeholder, replace with a valid API key if needed.
    // apiKey: 'AIzaSyAzWBtVvLSjvZE_I8ScHTOjjxbSVOVdBjA',
  },
});
